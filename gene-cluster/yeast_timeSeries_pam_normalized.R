...
root_lose=0
absolute_vs_root_list=c()
output_dir="timeCourse-result-uncentered-pam-normalized/"
...
root_lose=0
absolute_vs_root_list=c()
output_dir="timeCourse-result-pearson-pam-normalized/"
...
root_lose=0
absolute_vs_root_list=c()
output_dir="timeCourse-result-spearman-pam-normalized/"
...
root_lose=0
absolute_vs_root_list=c()
output_dir="timeCourse-result-uncentered-hcluster-normalized/"
...
root_lose=0
absolute_vs_root_list=c()
output_dir="timeCourse-result-pearson-hcluster-normalized/"
...
root_lose=0
absolute_vs_root_list=c()
output_dir="timeCourse-result-spearman-hcluster-normalized/"
...
root_lose=0
absolute_vs_root_list=c()
output_dir="timeCourse-result-compareSquare-hcluster-normalized/"
#plot_select_CHIndex("root absolute","average",output_dir)
...
root_lose=0
absolute_vs_root_list=c()
output_dir="timeCourse-result-compareSquare-pam-normalized/"
#plot_select_CHIndex("root absolute","pam",output_dir)
...
root_lose=0
absolute_vs_root_list=c()
output_dir="timeCourse-result-compareSquare-uncentered-pam-normalized-2019.5.8/"
...
root_lose=0
absolute_vs_root_list=c()
output_dir="timeCourse-result-compareSquare-spearman-hcluster-normalized-2019.5.6/"
dir.create(output_dir)
#plot_select_CHIndex("root spearman","average",output_dir)
...
root_lose=0
absolute_vs_root_list=c()
output_dir="timeCourse-result-compareSquare-spearman-pam-normalized-2019.5.6/"
dir.create(output_dir)
#plot_select_CHIndex("root spearman","pam",output_dir)
...
root_lose=0
absolute_vs_root_list=c()
output_dir="timeCourse-result-compareSquare-uncentered-hcluster-normalized-2019.5.6/"
dir.create(output_dir)
#plot_select_CHIndex("root uncentered","average",output_dir)
